...
def format_full_briefer(
    *,
    ...
    parts.append("")
    parts.append(
        "This briefing combines official legislative documents, fiscal data, "
        "and legislator voting records with artificial intelligence to produce "
        "a structured analysis. All source data comes from verified government "
        "and organizational sources. AI is used to summarize, contextualize, "
        "and assess momentum \u2014 not to generate facts, statistics, or quotes."
    )
    ...
    parts.append(
        "This briefer is an informational time-saver, not a replacement for "
        "personal judgment. It is not legal advice or a voting recommendation. "
